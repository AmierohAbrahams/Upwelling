...
try <- read_csv("/home/amieroh/Documents/Data/Datasets/GEBCO_2014_Grid/csv/BC_bathy.csv")


gv.plot <- function(data, plot.parameters, bathy) {
  fig <- ggplot(BC_annual_max, aes(x = lon, y = lat)) +
    geom_raster(aes(fill = y)) +
    #scale_fill_continuous_sequential(palette = "PuRd", na.value = "#011789", rev = TRUE) +
    stat_contour(data = try, aes(x = lon, y = lat, z = z),
...
AC.fig07 <- gv.plot(BC_annual_max, BC.layers, try)
```
